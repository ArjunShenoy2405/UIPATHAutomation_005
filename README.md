This process analyse an image and convert in into bitmap, collecting pixel coordinates and converting it into datatable. Later on, this data is treated as X-Y axis points.
